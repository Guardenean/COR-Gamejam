...
func _on_defesa_civil_pressed():
	check_selected("defesa_civil")

func _on_comlurb_pressed():
	check_selected("comlurb")

func _on_samu_pressed():
	check_selected("samu")

func _on_bombeiro_pressed():
	check_selected("bombeiro")

func _on_policia_militar_pressed():
	check_selected("pm")

func _on_alerta_rio_pressed():
	check_selected("alerta_rio")

func _on_geo_rio_pressed():
	check_selected("geo_rio")

func _on_rio_luz_pressed():
	check_selected("rioluz")

func _on_rio_aguas_pressed():
	check_selected("rioaguas")

func _on_cet_rio_pressed():
	check_selected("cet_rio")

func _on_conservacao_pressed():
